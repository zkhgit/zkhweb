 ...
 *
 * 赵凯浩
 * 2018年11月8日 下午2:05:40
 */
public class Excel2003Writer implements ExcelWriter{
     ...
     * @throws Exception
     */
    private <T> void createSheet(HSSFWorkbook wb, int sheetNum, List<T> data, String [] headerNames, String [] fieldNames, String fileName, String format) throws Exception {
        // 创建一个sheet表格
        HSSFSheet sheet = wb.createSheet("第" + ++sheetNum + "页");
    	// 获取第一行
     ...
     * @param format
     */
    private void typeRotation(HSSFCell cell, Object value, String format) {
